...
<div class="logo"><div class="logo-icon">U</div><span style="font-size:20px;font-weight:700">dockerscout</span></div>
`)
	...
	// Footer
	buf.WriteString(fmt.Sprintf(`<div class="footer">Generated by dockerscout Security Scanner &middot; Report ID: %s</div>`, data.ID.String()[:8]))
