...
func GenerateEnvFile(variables []*models.ConfigVariable) string {
	...
	sb.WriteString("# Generated by dockerscout Config Manager\n")
...
func GenerateDockerLabels(templateName string, hash string) map[string]string {
	return map[string]string{
		"dockerscout.config.managed":  "true",
		"dockerscout.config.template": templateName,
		"dockerscout.config.hash":     hash,
	}
}
